...
const editActions: ActionItem[] = [
  ...
  { icon: IconCopyPlus, label: 'Duplicate', action: () => usePolarisSession.duplicateSelection(store) },
  { icon: IconTrash2, label: 'Delete', action: () => usePolarisSession.deleteSelection(store) }
]
